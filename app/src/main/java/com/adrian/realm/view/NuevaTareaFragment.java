    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.button_crearTarea).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else tareasAppViewModel.insertarTarea(new Tarea(descripcionEditText.getText().toString(), LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")), idPrioridadSeleccionada));
